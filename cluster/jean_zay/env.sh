...
export GNBM_VENV="${GNBM_VENV:-$WORK/venvs/vascular-graph-extraction}"
export PATH="$WORK/tools/uv:$PATH"
export UV_CACHE_DIR="${UV_CACHE_DIR:-$WORK/.cache/uv}"
export TORCH_EXTENSIONS_DIR="${TORCH_EXTENSIONS_DIR:-$WORK/.cache/torch-extensions/gnbm-py310-cu112}"
